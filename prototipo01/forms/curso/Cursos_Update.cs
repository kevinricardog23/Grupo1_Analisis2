...
namespace prototipo01.forms.curso
{
    public partial class Cursos_Update : Form
    {
        ...
        {
            if (string.IsNullOrEmpty(txtbox_ID.Text) || string.IsNullOrEmpty(txtBox_nombre.Text) || string.IsNullOrEmpty(txtBox_semestre.Text) || string.IsNullOrEmpty(txtBox_Creditos.Text) || string.IsNullOrEmpty(cmbBox_Pensum.Text))
            {
